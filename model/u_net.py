...
from model.losses import bce_edges, bce_dice_loss, dice_loss, weighted_bce_dice_loss
...
def get_unet_128(input_shape=(128, 128, 3),
    ...
    down1 = Conv2D(64, (3, 3), padding='valid')(inputs)
    ...
    model.compile(optimizer=RMSprop(lr=0.0001), loss=bce_edges, metrics=[dice_loss])
...
def get_unet_1024(input_shape=(1024, 1024, 3),
    ...
    model.compile(optimizer=RMSprop(lr=0.0001), loss=bce_edges, metrics=[dice_loss, bce_dice_loss])

    return model


def get_enhanced_unet(input_shape=(1280, 1536, 3),
                  num_classes=1):
    inputs = Input(shape=input_shape)
    # 1024
    ...
    model.compile(optimizer=RMSprop(lr=0.0001), loss=weighted_bce_dice_loss, metrics=[dice_loss])
